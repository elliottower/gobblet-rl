# adapted from https://github.com/ray-project/ray/blob/master/rllib/examples/multi_agent_cartpole.py
...
if __name__ == "__main__":
    ...
    config = (
        PPOConfig()
        .environment(MultiAgentCartPole, env_config={"num_agents": args.num_agents, "render_mode": "human"})
